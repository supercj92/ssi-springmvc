...
public class MBeanManagerFactory {
	protected static transient Log logger = LogFactory.getLog(com.taobao.pamirs.schedule.MBeanManagerFactory.class);
	...
	public static MBeanServer getMbeanServer()
		...
		synchronized (com.taobao.pamirs.schedule.MBeanManagerFactory.class) {
			if (mbeanServer != null) {
				return mbeanServer;
			}
	...
	public void setJmxConnectorServer(JMXConnectorServer jmxConnectorServer) {
		com.taobao.pamirs.schedule.MBeanManagerFactory.jmxConnectorServer = jmxConnectorServer;
	}
}

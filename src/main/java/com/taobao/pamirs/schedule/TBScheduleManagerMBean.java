...
public class TBScheduleManagerMBean extends AbstractDynamicMBean {
	...
	public String getName() {
		...
		+"$"+	tbScheduleManager.getTaskTypeRunningInfo().getTaskType() + "$"
				+ tbScheduleManager.getCurrentSerialNumber();
	}
	public String getTaskType() {
		return tbScheduleManager.getTaskTypeRunningInfo().getTaskType();
	}
	...
	protected void buildDynamicMBeanInfo() {
		...
		dMBeanInfo = new MBeanInfo(this.getClass().getName(), "QueueDefine",
